 ...
 *
 * It extends `NavKey` so that a feature never has to. A destination is declared as
 * `data object Home : Route`, and Navigation3 stays a detail of `impl` rather than something every
 * feature module implements against.
 *
