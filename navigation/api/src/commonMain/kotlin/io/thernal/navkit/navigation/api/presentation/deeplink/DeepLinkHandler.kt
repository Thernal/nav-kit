...
/**
 * Resolves the pages one feature owns. Features contribute handlers; the dispatcher selects one.
 * Each page has exactly one owning handler — a duplicate is a startup error, not a silent
 * last-one-wins.
 */
