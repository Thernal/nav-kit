...
/**
 * Claims the run of consecutive bottom-sheet entries at the top of the stack, so a sheet that
 * pushes another sheet stays one surface with its own internal back stack instead of stacking two
...
private class BottomSheetScene<R : Route>(
    ...
    // to the consuming app's design system, not to a navigation library. Swap this content for the
    // app's own sheet and the strategy keeps working unchanged.
